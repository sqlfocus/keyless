                             ...
                             int *out_response_len)
{
    ...
    *out_response_len = 0;
    ...
    case KSSL_OP_RESPONSE:  // Other side sent response, error or pong: unexpected
    case KSSL_OP_ERROR:            /* 非服务器负责的请求 */
    case KSSL_OP_PONG:
    {
    ...
    case KSSL_OP_RSA_DECRYPT:      /* 利用私钥解密 */
