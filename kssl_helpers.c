...
kssl_error_code parse_message_payload(BYTE *payload,               //
    ...
    while (offset < len) {
        ...
        case KSSL_TAG_OPCODE:            /* 请求的操作，opcode */
        {
        ...
        case KSSL_TAG_SKI:               /* Public key SKI */
        {
            // Skip over malformed tags
        ...
        case KSSL_TAG_DIGEST:            /* An public key digest */
        {
            // Skip over malformed tags
        ...
        case KSSL_TAG_CLIENT_IP:         /* Client's IP address */
        {
    ...
    // 必须有负载及其对应的操作请求；check to see if opcode and payload are set
